(function () {
	...
	let url = `https://gftnth00.mywhc.ca/tim18/wp-json/wp/v2/posts?categories=5`;
	...
	fetch(url)
		...
		.then(function (data) {
			...
			console.log(data);
			let restapi = document.querySelector(".contenu__restapipays");
			...
			data.forEach(function (article) {
				...
				carte.classList.add("restapi__cartepays");
